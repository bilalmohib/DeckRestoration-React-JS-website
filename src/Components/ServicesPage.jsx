                        ...
                        <div className="row m-t-30">
                            ...
                            <div className="col-m-8 col-lg-8 col-sm-12 col-xs-12">
                                ...
                                <div className="email-form email-form2">
                                    <form action="#" id="info_form" autoComplete="off">
                                        <div className="row">
                                            <div className="col-md-12  m-b-5">
                                                <p className="email-head">Get a FREE Quote</p>
                                            </div>
                                            <div className="col-md-6 col-xs-12 m-b-5">
                                                <input type="text" name="name" className="form-control" value={this.state.name} onChange={(e) => this.setState({ name: e.target.value })} placeholder="Your Name" />
                                            </div>
                                            <div className="col-md-6 col-xs-12 m-b-5">
                                                <input type="text" placeholder="Your Email" className="form-control" value={this.state.email} onChange={(e) => this.setState({ email: e.target.value })} name="email" />
                                            </div>
                                            <div className="col-md-6 col-xs-12 m-b-5">
                                                <input type="text" placeholder="Your Phone" className="form-control" name="phone" value={this.state.phone} onChange={(e) => this.setState({ phone: e.target.value })} />
                                            </div>
                                            <div className="col-md-6 col-xs-12 m-b-5">
                                                <textarea placeholder="Your Message" name="address" value={this.state.address} onChange={(e) => this.setState({ address: e.target.value })} className="form-control" />
                                            </div>
                                        </div>
                                        <div className="row">
                                            <div className="col-md-12   m-b-5">
